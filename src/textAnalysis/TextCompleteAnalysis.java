...
public class TextCompleteAnalysis implements TextAnalysis {
	...
	public String getTitle() {
		return this.readable.getTitle();
	}
	
	public Map<String, Integer> wordList() {
		return this.readable.wordList();
	}
	...
	public Map<String, Double> getResults() {
		...
		resultsMap.putAll(this.readable.getResults());
		resultsMap.putAll(this.readable.getTextAnalysisResults());
		return resultsMap;
	}
}
